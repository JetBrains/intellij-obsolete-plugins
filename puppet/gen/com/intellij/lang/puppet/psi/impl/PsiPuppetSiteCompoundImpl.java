...
public class PsiPuppetSiteCompoundImpl extends PsiPuppetExpressionImpl implements PsiPuppetSiteCompound {

  public PsiPuppetSiteCompoundImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitSiteCompound(this);
  }
  ...
  public PsiPuppetBracedStatementsBlock getBracedStatementsBlock() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, PsiPuppetBracedStatementsBlock.class));
  }
