...
public class PsiPuppetExpressionFalseImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionFalse {

  public PsiPuppetExpressionFalseImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionFalse(this);
  }
