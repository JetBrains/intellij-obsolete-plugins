...
public class PsiPuppetRegularNameWrapperImpl extends PsiPuppetAnyNameWrapperImpl implements PsiPuppetRegularNameWrapper {

  public PsiPuppetRegularNameWrapperImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitRegularNameWrapper(this);
  }
