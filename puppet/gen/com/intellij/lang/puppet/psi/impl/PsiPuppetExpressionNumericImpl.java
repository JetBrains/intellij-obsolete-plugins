...
public class PsiPuppetExpressionNumericImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionNumeric {

  public PsiPuppetExpressionNumericImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionNumeric(this);
  }
