...
public class PsiPuppetExpressionIndexImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionIndex {

  public PsiPuppetExpressionIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionIndex(this);
  }
