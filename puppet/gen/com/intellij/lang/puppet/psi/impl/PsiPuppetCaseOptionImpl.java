...
public class PsiPuppetCaseOptionImpl extends PuppetCompositePsiElementBase implements PsiPuppetCaseOption {

  public PsiPuppetCaseOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitCaseOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiPuppetCaseValues getCaseValues() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, PsiPuppetCaseValues.class));
  }
