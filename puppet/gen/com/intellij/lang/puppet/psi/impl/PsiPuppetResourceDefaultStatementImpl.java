...
import com.intellij.lang.puppet.psi.mixins.PuppetResourceDeclarationBaseMixin;
import com.intellij.lang.puppet.psi.*;

public class PsiPuppetResourceDefaultStatementImpl extends PuppetResourceDeclarationBaseMixin implements PsiPuppetResourceDefaultStatement {

  public PsiPuppetResourceDefaultStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitResourceDefaultStatement(this);
  }
  ...
  public PsiPuppetBracedAnyArgumentsListBlock getBracedAnyArgumentsListBlock() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, PsiPuppetBracedAnyArgumentsListBlock.class));
  }
