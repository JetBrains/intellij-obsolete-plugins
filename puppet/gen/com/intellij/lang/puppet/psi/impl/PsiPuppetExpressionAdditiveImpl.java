...
public class PsiPuppetExpressionAdditiveImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionAdditive {

  public PsiPuppetExpressionAdditiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionAdditive(this);
  }
