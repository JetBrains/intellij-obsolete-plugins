...
public class PsiPuppetExpressionUndefImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionUndef {

  public PsiPuppetExpressionUndefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionUndef(this);
  }
