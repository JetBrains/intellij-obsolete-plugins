...
public class PsiPuppetHashArrayIndexImpl extends PuppetCompositePsiElementBase implements PsiPuppetHashArrayIndex {

  public PsiPuppetHashArrayIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitHashArrayIndex(this);
  }
