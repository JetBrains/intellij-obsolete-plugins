...
public class PsiPuppetInterpolatedBlockImpl extends PsiPuppetBlockImpl implements PsiPuppetInterpolatedBlock {

  public PsiPuppetInterpolatedBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitInterpolatedBlock(this);
  }
