...
public class PsiPuppetConsumesStatementImpl extends PsiPuppetExpressionImpl implements PsiPuppetConsumesStatement {

  public PsiPuppetConsumesStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitConsumesStatement(this);
  }
