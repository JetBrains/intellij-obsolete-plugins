...
public class PsiPuppetParenthesizedExpressionsListBlockImpl extends PsiPuppetBlockImpl implements PsiPuppetParenthesizedExpressionsListBlock {

  public PsiPuppetParenthesizedExpressionsListBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitParenthesizedExpressionsListBlock(this);
  }
