...
public class PsiPuppetExpressionRelationImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionRelation {

  public PsiPuppetExpressionRelationImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionRelation(this);
  }
