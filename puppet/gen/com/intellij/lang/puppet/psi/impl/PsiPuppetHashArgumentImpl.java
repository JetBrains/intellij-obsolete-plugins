...
public class PsiPuppetHashArgumentImpl extends PuppetCompositePsiElementBase implements PsiPuppetHashArgument {

  public PsiPuppetHashArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitHashArgument(this);
  }
