...
public class PsiPuppetHashValueImpl extends PsiPuppetExpressionImpl implements PsiPuppetHashValue {

  public PsiPuppetHashValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PsiPuppetHashPair> getHashPairList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PsiPuppetHashPair.class);
  }
