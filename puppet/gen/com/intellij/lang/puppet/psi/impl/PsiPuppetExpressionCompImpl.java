...
public class PsiPuppetExpressionCompImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionComp {

  public PsiPuppetExpressionCompImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionComp(this);
  }
