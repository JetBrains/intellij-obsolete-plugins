...
public class PsiPuppetNodeNamesListImpl extends PuppetCompositePsiElementBase implements PsiPuppetNodeNamesList {

  public PsiPuppetNodeNamesListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitNodeNamesList(this);
  }
