...
public class PsiPuppetCollectRHandImpl extends PuppetCompositePsiElementBase implements PsiPuppetCollectRHand {

  public PsiPuppetCollectRHandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitCollectRHand(this);
  }
