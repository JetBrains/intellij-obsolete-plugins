...
public class PsiPuppetExpressionRegexImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionRegex {

  public PsiPuppetExpressionRegexImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionRegex(this);
  }
