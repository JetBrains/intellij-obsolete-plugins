...
public class PsiPuppetExpressionInImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionIn {

  public PsiPuppetExpressionInImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionIn(this);
  }
