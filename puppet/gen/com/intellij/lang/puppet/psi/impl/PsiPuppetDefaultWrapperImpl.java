...
public class PsiPuppetDefaultWrapperImpl extends PsiPuppetAnyNameWrapperImpl implements PsiPuppetDefaultWrapper {

  public PsiPuppetDefaultWrapperImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitDefaultWrapper(this);
  }
