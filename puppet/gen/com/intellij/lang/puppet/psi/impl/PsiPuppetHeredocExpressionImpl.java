...
public class PsiPuppetHeredocExpressionImpl extends PsiPuppetExpressionImpl implements PsiPuppetHeredocExpression {

  public PsiPuppetHeredocExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitHeredocExpression(this);
  }
