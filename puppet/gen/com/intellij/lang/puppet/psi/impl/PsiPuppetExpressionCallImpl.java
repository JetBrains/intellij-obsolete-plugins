...
public class PsiPuppetExpressionCallImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionCall {

  public PsiPuppetExpressionCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionCall(this);
  }
