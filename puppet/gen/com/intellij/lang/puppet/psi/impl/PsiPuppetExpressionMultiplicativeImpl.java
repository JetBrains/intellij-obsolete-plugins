...
public class PsiPuppetExpressionMultiplicativeImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionMultiplicative {

  public PsiPuppetExpressionMultiplicativeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionMultiplicative(this);
  }
