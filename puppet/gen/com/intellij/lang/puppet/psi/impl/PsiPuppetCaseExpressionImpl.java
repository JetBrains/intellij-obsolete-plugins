...
public class PsiPuppetCaseExpressionImpl extends PsiPuppetExpressionImpl implements PsiPuppetCaseExpression {

  public PsiPuppetCaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiPuppetBracedCaseOptsBlock getBracedCaseOptsBlock() {
    return PsiTreeUtil.getChildOfType(this, PsiPuppetBracedCaseOptsBlock.class);
  }
