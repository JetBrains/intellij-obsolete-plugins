...
public class PsiPuppetExpressionIndexedImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionIndexed {

  public PsiPuppetExpressionIndexedImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionIndexed(this);
  }
