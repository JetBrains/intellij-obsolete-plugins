...
public class PsiPuppetCapitalizedNameWrapperImpl extends PsiPuppetAnyNameWrapperImpl implements PsiPuppetCapitalizedNameWrapper {

  public PsiPuppetCapitalizedNameWrapperImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitCapitalizedNameWrapper(this);
  }
