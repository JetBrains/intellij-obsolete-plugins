...
public class PsiPuppetCollExprImpl extends PuppetCompositePsiElementBase implements PsiPuppetCollExpr {

  public PsiPuppetCollExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitCollExpr(this);
  }
