...
public class PsiPuppetDataTypeParametersBlockImpl extends PsiPuppetBlockImpl implements PsiPuppetDataTypeParametersBlock {

  public PsiPuppetDataTypeParametersBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitDataTypeParametersBlock(this);
  }
