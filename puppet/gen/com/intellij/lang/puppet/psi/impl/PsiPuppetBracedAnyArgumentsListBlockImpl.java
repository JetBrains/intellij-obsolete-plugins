...
public class PsiPuppetBracedAnyArgumentsListBlockImpl extends PsiPuppetBlockImpl implements PsiPuppetBracedAnyArgumentsListBlock {

  public PsiPuppetBracedAnyArgumentsListBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitBracedAnyArgumentsListBlock(this);
  }
