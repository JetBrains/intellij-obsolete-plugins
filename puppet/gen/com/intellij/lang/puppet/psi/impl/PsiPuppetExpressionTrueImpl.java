...
public class PsiPuppetExpressionTrueImpl extends PsiPuppetExpressionImpl implements PsiPuppetExpressionTrue {

  public PsiPuppetExpressionTrueImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPuppetVisitor visitor) {
    visitor.visitExpressionTrue(this);
  }
