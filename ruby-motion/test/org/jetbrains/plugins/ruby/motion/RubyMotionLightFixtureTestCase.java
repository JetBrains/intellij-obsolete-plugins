 ...
 */
public abstract class RubyMotionLightFixtureTestCase extends RubyLightFixtureTestCase<RubyMotionLightFixtureTestCase.RubyMotionLightFixtureDescriptor> {
  @Override
  ...
  protected String getTestDataPath() {
    return new File("test/org/jetbrains/plugins/ruby/motion/data/" + getTestDataRelativePath()).getAbsolutePath();
  }

  @Nullable
  @Override
  protected RubyMotionLightFixtureDescriptor createProjectDescriptor() {
