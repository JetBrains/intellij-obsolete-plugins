...
/**
 * http://jbpm.org/4.3/jpdm:valueElemType interface.
 */
public interface Value extends JpdlDomElement {
  ...
  @NotNull
  @Required
  com.intellij.jboss.bpmn.jpdl.model.xml.wireObjectGroup.Double getDouble();
