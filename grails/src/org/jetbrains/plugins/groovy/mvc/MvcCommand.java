...
public class MvcCommand {
  ...
  public static final Collection<String> ourEnvironments = List.of("prod", "test", "dev");
   ...
   */
  public @NotNull Map<String, String> getEnvVariables() {
  ...
  public static @NotNull MvcCommand parse(@NotNull String cmd) {
