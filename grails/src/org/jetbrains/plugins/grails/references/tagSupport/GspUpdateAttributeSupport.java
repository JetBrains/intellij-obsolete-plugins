...
public class GspUpdateAttributeSupport extends TagAttributeReferenceProvider {

  protected GspUpdateAttributeSupport() {
    super("update", "g", null);
  }
  ...
  public PsiReference @NotNull [] getReferencesByElement(@NotNull PsiElement element,
    ...
    return new PsiReference[]{new IdRefReference(element, offset, true) {
      @Override
