...
public class TestModuleOutputPackagingElementAntGenerator extends ModuleOutputPackagingElementAntGenerator {
  @Override
  protected String getDirectoryAntProperty(ModuleOutputPackagingElementBase packagingElement, ArtifactAntGenerationContext generationContext) {
    return generationContext.getModuleTestOutputPath(packagingElement.getModuleName());
  }
}
