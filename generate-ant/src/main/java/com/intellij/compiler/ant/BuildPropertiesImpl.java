...
public class BuildPropertiesImpl extends BuildProperties {
  ...
  public BuildPropertiesImpl(Project project, final GenerationOptions genOptions) {
    ...
    add(new Comment(GenerateAntBundle.message("generated.ant.build.disable.tests.property.comment"),
    ...
    add(new Comment(GenerateAntBundle.message("generated.ant.build.compiler.options.comment")), 1);
    ...
    final Generator projectLibs = factory.create(registrar.getLibraryTable(project), getProjectBaseDir(project),
                                                 GenerateAntBundle.message("generated.ant.build.project.libraries.comment"));
    if (projectLibs != null) {
      add(projectLibs);
    }

    final Generator globalLibs =
      factory.create(registrar.getLibraryTable(), null, GenerateAntBundle.message("generated.ant.build.global.libraries.comment"));
    if (globalLibs != null) {
      add(globalLibs);
    }
    ...
    if (genOptions.enableFormCompiler || customCompilers.length > 0) {
      add(new Comment(GenerateAntBundle.message("generated.ant.build.custom.compilers.comment")));
  ...
  protected void createJdkGenerators(final Project project) {
    ...
    if (jdks.length > 0) {
      add(new Comment(GenerateAntBundle.message("generated.ant.build.jdk.definitions.comment")), 1);
