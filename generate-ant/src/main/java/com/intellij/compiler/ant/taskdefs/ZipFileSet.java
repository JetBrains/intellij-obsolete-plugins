...
public class ZipFileSet extends Tag {
  public static final com.intellij.compiler.ant.taskdefs.ZipFileSet[] EMPTY_ARRAY = new com.intellij.compiler.ant.taskdefs.ZipFileSet[0];
  ...
  public static com.intellij.compiler.ant.taskdefs.ZipFileSet createUnpackedSet(@NonNls String zipFilePath, @NotNull String relativePath, final boolean isDir) {
    return new com.intellij.compiler.ant.taskdefs.ZipFileSet("zipfileset",
