...
public class GenerateAntApplication {
  private static final Logger LOG = Logger.getInstance(com.intellij.compiler.ant.GenerateAntApplication.class);
  ...
  public void run() {
    try {
      ...
      GenerateAntBuildFileAction.generateSingleFileBuild(myProject,
