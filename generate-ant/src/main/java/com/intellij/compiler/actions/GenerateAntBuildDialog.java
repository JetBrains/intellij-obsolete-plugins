...
import com.intellij.compiler.ant.GenerateAntBundle;
...
public class GenerateAntBuildDialog extends DialogWrapper {
  ...
  public GenerateAntBuildDialog(Project project) {
    super(project, false);
    myProject = project;
    setTitle(GenerateAntBundle.message("generate.ant.build.title"));
    init();
    loadSettings();
  }
  ...
  private void initChunksPanel() {
    ...
    myChunksPanel.setBorder(
      IdeBorderFactory.createTitledBorder(GenerateAntBundle.message("generate.ant.build.dialog.cyclic.modules.table.title")));
    JLabel textLabel = new JLabel(GenerateAntBundle.message("generate.ant.build.dialog.cyclic.modules.table.description"));
  ...
  private static class MyTableModel extends AbstractTableModel {
    ...
    public String getColumnName(int columnIndex) {
      switch (columnIndex) {
        case NUMBER_COLUMN:
          return GenerateAntBundle.message("generate.ant.build.dialog.cyclic.modules.table.number.column.header");
        case NAME_COLUMN:
          return GenerateAntBundle.message("generate.ant.build.dialog.cyclic.modules.table.name.column.header");
      }
