...
public final class MapMultibindMatchStrategy implements GuiceBindingMatchStrategy {
  ...
  public boolean isRelevantType(@NotNull PsiType targetType) {
    return GuiceUtils.getMultibinderValueType(targetType) != null;
  }

  @Override
  public @Nullable PsiType unwrapType(@NotNull PsiType type) {
    return GuiceUtils.getMultibinderValueType(type);
  }
      ...
      try {
        ...
        if (productType != null &&
            ...
            (AnnotationUtil.isAnnotated(provides.getPsiElement(),
                GuiceAnnotations.PROVIDES_INTO_MAP, 0) ||
             AnnotationUtil.isAnnotated(provides.getPsiElement(),
                GuiceAnnotations.CHECKED_PROVIDES_INTO_MAP, 0)) &&
