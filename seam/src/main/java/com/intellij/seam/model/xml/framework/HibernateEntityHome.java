...
/**
 * http://jboss.com/products/seam/framework:hibernate-entity-homeElemType interface.
 */
public interface HibernateEntityHome extends SeamFrameworkDomElement, BasicSeamComponent {
