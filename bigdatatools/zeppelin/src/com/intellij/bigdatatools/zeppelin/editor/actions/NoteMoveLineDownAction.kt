...
class NoteMoveLineDownAction : EditorAction(MoveStatementDownAction().handler),
                               ZeppelinEditorAction


class NoteMoveLineUpAction : EditorAction(MoveStatementUpAction().handler),
                             ZeppelinEditorAction
