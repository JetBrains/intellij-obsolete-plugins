...
class FlinkJobCheckpointsOverviewController(project: Project, override val dataManager: FlinkDataManager) :
  ...
  override fun getFieldsGroupModel(id: String) = dataManager.getJobCheckpointsOverviewModel(id)
