...
class DataprocHiveJobConfBlock(project: Project,
  ...
  override fun fillByJob(jobInfo: DataprocJobInfo) {
    val job = jobInfo.job.hiveJob
    queryTypeField.isSelected = job.queriesCase == HiveJob.QueriesCase.QUERY_FILE_URI
  ...
  override fun applyToJobBuilder(builder: Job.Builder) {
    val jobBuilder = builder.hiveJobBuilder
