...
class DataprocSparkSqlJobConfBlock(project: Project,
  ...
  override fun fillByJob(jobInfo: DataprocJobInfo) {
    val job = jobInfo.job.sparkSqlJob
    queryTypeField.isSelected = job.queriesCase == SparkSqlJob.QueriesCase.QUERY_FILE_URI
  ...
  override fun applyToJobBuilder(builder: Job.Builder) {
    val jobBuilder = builder.sparkSqlJobBuilder
