...
class HiveMetastoreSettingsProvider : ConnectionSettingProvider {
  override val pluginType: BdtPluginType = BdtPluginType.METASTORE_CORE
  override fun createConnectionGroups(): List<ConnectionGroup> = listOf(HiveMetastoreConnectionGroup())
}