...
public abstract class LightOsgiFixtureTestCase extends LightJavaCodeInsightFixtureTestCase {
  private static final DefaultLightProjectDescriptor OSGi_DESCRIPTOR = new DefaultLightProjectDescriptor() {
    ...
    public void configureModule(@NotNull Module module, @NotNull ModifiableRootModel model, @NotNull ContentEntry contentEntry) {
      ...
      MavenDependencyUtil.addFromMaven(model,"biz.aQute.bnd:biz.aQute.bndlib:5.3.0");
      MavenDependencyUtil.addFromMaven(model,"biz.aQute.bnd:biz.aQute.repository:5.3.0");
      MavenDependencyUtil.addFromMaven(model,"org.codehaus.plexus:plexus-utils:3.5.1");
