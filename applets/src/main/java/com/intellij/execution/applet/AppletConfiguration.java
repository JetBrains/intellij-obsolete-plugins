...
public class AppletConfiguration extends ModuleBasedConfiguration<JavaRunConfigurationModule, AppletConfigurationOptions>
  ...
  public void checkConfiguration() throws RuntimeConfigurationException {
    if (getOptions().isAlternativeJrePathEnabled() && (StringUtil.isEmptyOrSpaces(getOptions().getAlternativeJrePath()) || !JdkUtil.checkForJre(getOptions().getAlternativeJrePath()))) {
      throw new RuntimeConfigurationWarning(AppletBundle.message("jre.not.valid.error.message", getOptions().getAlternativeJrePath()));
    }
    getConfigurationModule().checkForWarning();
    if (getOptions().getHtmlUsed()) {
      if (getOptions().getHtmlFileName() == null) {
        throw new RuntimeConfigurationWarning(AppletBundle.message("html.file.not.specified.error.message"));
      }
      try {
      ...
      getConfigurationModule().checkClassName(getOptions().getMainClassName(), AppletBundle.message("no.applet.class.specified.error.message"));
    }
  }
  ...
  private AppletHtmlFile getHtmlURL() throws CantRunException {
    if (getOptions().getHtmlUsed()) {
      if (getOptions().getHtmlFileName() == null) {
        throw new CantRunException(AppletBundle.message("html.file.not.specified.error.message"));
      }
      return new AppletHtmlFile(getOptions().getHtmlFileName(), null);
    } else {
      if (getOptions().getMainClassName() == null) {
        throw new CantRunException(AppletBundle.message("class.not.specified.error.message"));
      }
      ...
      try {
        ...
        throw new CantRunException(AppletBundle.message("failed.to.generate.wrapper.error.message"));
      }
    }
  }
