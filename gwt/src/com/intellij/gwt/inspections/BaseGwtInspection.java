...
public abstract class BaseGwtInspection extends AbstractBaseJavaLocalInspectionTool {
  ...
  protected static @Nullable GwtFacet getFacet(@NotNull PsiElement psiElement) {
    return GwtFacet.findFacetBySourceFile(psiElement.getProject(), psiElement.getContainingFile().getVirtualFile());
  }

  protected static @NotNull PsiElement getElementToHighlight(@NotNull PsiClass psiClass) {
    PsiIdentifier identifier = psiClass.getNameIdentifier();
    return identifier != null ? identifier : psiClass;
  }

  protected static @NotNull PsiElement getElementToHighlight(@NotNull PsiMethod psiMethod) {
